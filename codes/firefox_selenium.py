...
class Driver:
    ...
    def openPage(self,url):
        ...
        # wait until video box displayed
        try:
        ...
        # first play an advertisement. must to cross over it
        ...
        # get video duration using aparat api
